...
int main() {
    ...
    node *second = new node(2.0, 1);
    node *third = new node(3.0, 2);
    ...
    polynomial p2;
    node *first1 = new node(5.0, 2);
    node *second2 = new node(4.0, 3);
    node *third3 = new node(3.0, 4);
    node *forth4 = new node(2.0, 5);
